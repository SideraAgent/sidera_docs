...
1. Whether the strategy is allowed to trade.
2. Whether the market is supported by the connected venue.
3. Whether account balance and margin are sufficient.
4. Whether the order respects position, leverage, and drawdown limits.
5. Whether market conditions are abnormal, illiquid, or outside the strategy's intended regime.
6. Whether required stops, exits, or intervention rules are present.
7. Whether the decision is logged for review.
