...
1. Open [sidera.markets](https://sidera.markets/).
2. Choose the sign-up or sign-in option available in the app.
3. If using a wallet, connect the browser wallet and confirm the signature request.
4. If using email, create an account with your email and password.
5. Complete any onboarding steps shown in the workspace.
...
### The active wallet account is different
