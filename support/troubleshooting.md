...
{% stepper %}
{% step %}
## Open the wallet extension manually
{% endstep %}

{% step %}
## Confirm the extension is unlocked
{% endstep %}
...
{% step %}
## Refresh Sidera and reconnect
{% endstep %}

{% step %}
## Confirm the connected wallet address is the one you expect
{% endstep %}
{% endstepper %}
