...
3. Start with a market prompt.
4. Generate an AI thesis.
5. Convert the thesis into strategy rules.
6. Backtest and validate the rules.
7. Configure RiskGuard limits.
8. Deploy the strategy in dry-run mode.
9. Review the decision logs before live trading.
...
## Step 2: Start with a market prompt
...
## Step 4: Convert thesis into rules
