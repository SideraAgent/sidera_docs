...
2. Add realistic fees and slippage.
3. Test across different market regimes.
4. Change one parameter at a time.
5. Run out-of-sample or more recent period checks.
6. Compare against a simple benchmark.
7. Move to dry-run before live trading.
